...
| **Official Docs** | [docs.stackit.cloud](https://docs.stackit.cloud/) | STACKIT official documentation — all services, API references, SKE, Object Storage, DNS, and platform guides. |
| **Terraform Provider (STACKIT)** | [registry.terraform.io/stackitcloud/stackit](https://registry.terraform.io/providers/stackitcloud/stackit/latest/docs) | Official STACKIT Terraform provider — manages SKE clusters, PostgreSQL Flex, Object Storage, DNS zones, load balancers, and IAM resources. |
| **OpenTofu Provider (STACKIT)** | [search.opentofu.org/stackitcloud/stackit](https://search.opentofu.org/provider/stackitcloud/stackit/latest) | STACKIT provider in the OpenTofu registry — same capabilities as the Terraform provider, open-source friendly. |
